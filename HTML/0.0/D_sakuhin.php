...
<!-- おわ-->
        ...
        <article>
          <div class="content">
            <p>a</p>
<!-- table上-->
<iframe name = "main" class="yaa" src="iframe_sd/d_sakuhin.php" frameborder="0" scrolling="yes"width="1200" height="750"></iframe>
        </tr>
        </tr>
      </td>
<!-- /table上-->
